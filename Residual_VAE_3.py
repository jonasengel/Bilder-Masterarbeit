...
class Predictor():
    ...
    def tsne(self):
        ...
        latent_var = latent_var.reshape(len(os.listdir(img_path + '/Test/test')), latent_dim)
    ...
    def img_algebra(self, img_num):
        ...
        predictions = []
        test_pred = vae.predict(test_generator[img_num_1])
        test_pred = np.reshape(test_pred, (128, 128, 1))
